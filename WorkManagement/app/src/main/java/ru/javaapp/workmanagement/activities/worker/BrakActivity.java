...
public class BrakActivity extends AppCompatActivity {
    ...
    private void componentsInitialize() {
        ...
        chEquipment = (CheckBox) findViewById(R.id.chbx_brak_equipment);
        chTools = (CheckBox) findViewById(R.id.chbx_brak_tools);
        chHarvesting = (CheckBox) findViewById(R.id.chbx_brak_harvesting);
        chOther = (CheckBox) findViewById(R.id.chbx_brak_other);
    }
