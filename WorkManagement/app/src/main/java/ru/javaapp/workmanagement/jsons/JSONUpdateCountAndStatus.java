 ...
 */
public class JSONUpdateCountAndStatus extends AsyncTask<String, Void, String> {

    HttpURLConnection urlConnection;
    int taskId, currentcount, statusId, code;
    Context context;

    public JSONUpdateCountAndStatus(int taskId, int currentCount, int statusId, Context context){
        this.taskId = taskId;
